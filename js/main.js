...
- Are the variables what they claim to be?  yes except y must be consoled into the function
- What would console.log(y) and console.log(x) print? Why?  console Y where it is is consoled as undefined, console X is fine
...
/*************************************************************************************
------------ ANSWER -------------------
console y will not define where it is located in the code.. console x will
...
/*************************************************************************************
------------ ANSWER -------------------
console.log(x)=undefine (too early in code)
console.log(y) is literally not even on here..
**************************************************************************************/
